...
1. Make sure you do the [[Contributing#^c0dd79]] section first!
2. `git add *`
3. `git status`
4. If there is anything that you think should be committed, you'll need to manually add it to the commit by doing (replacing the FILENAME  with the... uh, filename.). 
...
5. `git status FILENAME` (double check again)
