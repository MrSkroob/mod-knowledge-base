...
Heck, I didn't know that `this` is a clusterfuck. Apparently, in RPGMaker MV, you can do:
```javascript
...
window.$zero = 0
```
#### Some more examples (may or may not be related to the previous section)
